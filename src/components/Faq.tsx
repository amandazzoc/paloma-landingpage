...
export default function Faq() {
  return (
    <div className="flex flex-col justify-between items-center gap-2.5 lg:py-32 lg:px-[320px]">
        ...
        <div className="flex flex-col items-center justify-center md:w-1/2 md:gap-6 gap-4">
          <div className="flex flex-col items-center justify-center">
            ...
            <div className="flex flex-col gap-3 text-center">
              <p className="font-baloo text-[var(--primary)] md:text-4xl text-xl">
                Ainda com dúvidas?
              </p>
          ...
          <Button text="QUERO TIRAR AS MINHAS DÚVIDAS!" onClick={() => {}} />
        </div>

        <div className="flex flex-col md:w-1/2 gap-5">
          <p className="md:text-4xl text-xl md:text-start text-center">
